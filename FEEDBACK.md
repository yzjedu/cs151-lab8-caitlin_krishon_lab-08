...
- `random.randint(2,12)` this should be `random.randint(1,6)` + `random.randint(1,6)` other wise the distribution wont be created
- You are writing a function inside a function. It might work, but this is not how you write a function and call a function. 
- 
